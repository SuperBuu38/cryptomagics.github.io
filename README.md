        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function fetchAllNFTs(walletName, schemaFilter, collectionName) {
                ...
                function displayNFTs() {
                    ...
                    nftEntries.forEach(nft => {
                        ...
                        // Construire une clé unique pour chaque NFT
            ...
            function startFetching() {
                ...
                if (walletName.trim() !== '') {
                    ...
                    alert('Veuillez entrer un nom de wallet.');
                }
...
<body>
    ...
    <label for="wallet-input">Nom du wallet :</label>
    <input type="text" id="wallet-input" placeholder="Entrez le nom du wallet">

    <label for="schema-input">Nom du schéma :</label>
    <input type="text" id="schema-input" placeholder="Entrez le nom du schéma">

    <label for="collection-input">Nom de la collection :</label>
    <input type="text" id="collection-input" placeholder="Entrez le nom de la collection">
